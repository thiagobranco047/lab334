...
const archive = path.resolve("vendor/contracts/lab334-contracts-0.1.2.tgz");
...
if (locked?.version !== "0.1.2" || !locked.integrity) throw new Error("package-lock does not pin @lab334/contracts@0.1.2 with integrity");
console.log(`@lab334/contracts@0.1.2 verified ${digest}`);
