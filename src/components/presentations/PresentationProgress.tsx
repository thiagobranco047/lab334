    ...
    <div className="pointer-events-none fixed inset-x-0 top-0 z-50 border-b border-proposal-line bg-proposal-bg/95 backdrop-blur-sm">
      <div className="grid grid-cols-[1fr_auto] items-center gap-x-4 px-5 py-4 sm:grid-cols-[1fr_minmax(0,1200px)_1fr] sm:gap-x-6 sm:px-8 sm:py-5">
        ...
        <div className="hidden min-w-0 sm:col-start-2 sm:block">
          <div className="relative h-px overflow-hidden bg-proposal-line">
            <motion.div
              className="absolute inset-y-0 left-0 bg-proposal-fg"
              initial={false}
          ...
          <p className="font-display text-sm font-light tracking-[0.18em] text-proposal-muted">
            <AnimatePresence mode="popLayout" initial={false}>
              <motion.span
                ...
                className="inline-block text-proposal-fg"
              >
                {padSlideNumber(current)}
              </motion.span>
            </AnimatePresence>
            <span className="text-proposal-line"> / </span>
